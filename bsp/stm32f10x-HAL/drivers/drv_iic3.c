...
{
    if(state == 1)
		rt_pin_write(eTem3_SDA,PIN_HIGH);
    else
		rt_pin_write(eTem3_SDA,PIN_LOW);
}
/*
* brief: IIC SET SCL.
* param: state  set 0 or 1
...
{
    if(state == 1)
       rt_pin_write(eTem3_SCL,PIN_HIGH);
    else
       rt_pin_write(eTem3_SCL,PIN_LOW);
}
/*
* brief: IIC GET SCL.
* param: None
